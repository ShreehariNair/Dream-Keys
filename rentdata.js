...
request.addEventListener('load',function(){
  ...
  let properties = JSON.parse(this.responseText);
    ...
    document.querySelector('.search-btn').addEventListener('click',function(e){
          ...
          request.open('GET',`get_data.php?q=${q}&type='rent'`);
          request.send();
    })
    ...
    document.querySelector('#price-filter .done-btn').addEventListener('click',function(e){
      ...
      request.open('GET',`get_data.php?minprice=${Number(minprice)}&maxprice=${Number(maxprice)}&type='rent'`);
      request.send();
    ...
    document.querySelector('#beds-filter .done-btn').addEventListener('click',function(e){
      ...
      request.open('GET',`get_data.php?rooms=${Number(rooms)}&beds=${Number(beds)}&type='rent'`);
      request.send();
    ...
    document.querySelector('#size-filter .done-btn').addEventListener('click',function(e){
      ...
      minsizeEl.value = '';
      maxsizeEl.value = '';
      request.open('GET',`get_data.php?minsize=${Number(minsize)}&maxsize=${Number(beds)}&type='rent'`);
      request.send();
