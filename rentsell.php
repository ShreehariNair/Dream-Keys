  ...
  <button id="form-1-btn">Next</button>    
        ...
        <div class="container-3 hidden">
          ...
          <div class="upload-container">
              ...
              <div class="input-container" id="video-container">
                <label>Paste your video url here</label>
                <input type="text" class="input-box" id="video-url">
              </div>
          </div>
